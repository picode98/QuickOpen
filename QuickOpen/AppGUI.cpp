...
QuickOpenSettings::
QuickOpenSettings(QuickOpenApplication& appRef): wxFrame(nullptr, wxID_ANY, wxT("Settings")),
                                                            appRef(appRef)
{
...
QuickOpenTaskbarIcon::TaskbarMenu::TaskbarMenu(QuickOpenApplication& appRef, TrayStatusWindow* statusWindow): appRef(appRef),
